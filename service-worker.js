const CACHE='school-escape-v8-bgm-20260906';
...
self.addEventListener('fetch',e=>{
  ...
  const fresh=url.pathname.endsWith('/assets/hotfix-hidden-inline.js')||url.pathname.endsWith('/assets/hidden-ending-small.b64')||url.pathname.endsWith('/assets/hotfix-ending-art.js')||url.pathname.endsWith('/assets/hotfix-creator-ui.js')||url.pathname.endsWith('/assets/hotfix-final-timer.js')||url.pathname.endsWith('/assets/creator-v2.css');
  if(fresh){
